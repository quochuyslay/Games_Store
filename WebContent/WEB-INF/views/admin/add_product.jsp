							...
							<div class="section-detail">
								<div class="table-responsive">
									<table class="table list-table-wp">
										...
										<form:form action="add_product.htm" modelAttribute="add_product">
											<tbody>
												<tr>											
											...
											<button type="submit" name="btn-submit" id="add_product">Thêm mới</button>
										<ul>
											<li>
												<form:errors path="loai_sp" style="color: red;"/>
											</li>
											<li>
												<form:errors path="anh_post" style="color: red;"/>
											</li>
											<li>
												<form:errors path="ten" style="color: red;"/>
											</li>
											<li>
												<form:errors path="gia" style="color: red;"/>
											</li>
											<li>
												<form:errors path="anh_1" style="color: red;"/>
											</li>
											<li>
												<form:errors path="anh_2" style="color: red;"/>
											</li>
											<li>
												<form:errors path="anh_3" style="color: red;"/>
											</li>
											<li>
												<form:errors path="anh_4" style="color: red;"/>
											</li>																																	
										</ul>
										</form:form>											
									</table>									
