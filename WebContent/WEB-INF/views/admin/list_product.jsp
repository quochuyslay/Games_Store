...
<script src="http://localhost:9999/Clothes_Store/admin/public/js/test.js" type="text/javascript"></script>
</head>
<body>
	<div id="site">
		<div id="container">
								...
								<div class="table-responsive">
									<table class="table list-table-wp">
										...
										<c:forEach var="u" items="${list_product}">
											<tbody>
												<tr class="fbbox">
													<td><span class="tbody-text">${u.id }</span>
													<td><span class="tbody-text">${u.loai_sp }</span>
													<td>
													...
													<td><span class="tbody-text"><c:set
																var="accountBalance" value="${u.gia }" /> 
													...
													<td>
														<div class="tbody-thumb">															
															<ul class="list-operation fl-right">
	                                            				<li><a href="${u.id}.htm" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
					                                            <li><a href="delete_product.htm" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
					                                        </ul>
														</div>
													</td>
												</tr>
